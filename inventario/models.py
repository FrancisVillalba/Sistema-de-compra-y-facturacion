...
class SubCategoria(ClaseModelo):
    ...
    descripcion = models.CharField(max_length=100, help_text='Descripción de la Subcategoria')
...
class Producto(ClaseModelo):
    ...
    descripcion = models.CharField(max_length=100, help_text='Descripción de productos', unique=True)
